...
- <strong>Safe audition:</strong> per-track preview volume and mute controls from −60 dB to +12 dB, plus an optional playback limiter.
...
- <strong>安全试听：</strong> 每轨可独立调整 −60 dB 至 +12 dB 的试听音量或静音，并可选开启试听限幅器。
